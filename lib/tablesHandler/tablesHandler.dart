...
class TablesHandler {
    ...
    Future<Map<String, dynamic>> loadTablesCharacterKatafract() async {
    	final String jsonString = await rootBundle.loadString('lib/assets/tablesStorage/characterTables/tables_character_katafract.json');
    	final Map<String, dynamic> jsonData = json.decode(jsonString);
    	return jsonData;
  	}
    Future<Map<String, dynamic>> loadGenerationResultsList() async {
    	final String jsonString = await rootBundle.loadString('lib/assets/tablesStorage/generationResultsTables/generation_results.json');
    	final Map<String, dynamic> jsonData = json.decode(jsonString);
    	return jsonData;
  	}
