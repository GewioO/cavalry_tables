...
class Tableslist extends StatefulWidget {
    ...
    const Tableslist({Key? key, required this.tablesHandler, required this.tablesCharacter,
      required this.onResultSelected, required this.updateTempTable, required this.tablesCharacterEquipment,
      required this.tablesCharacterExtras, required this.tablesCharacterSkills}) : super(key: key);
...
class _TableslistState extends State<Tableslist> {
    ...
    Widget build(BuildContext context) {
        return ListView(
            children: [
                ExpansionTile(title: Text('Таблиці персонажа'),
                    children: [
                      Column(
                ...
                ExpansionTile(title: Text('Таблиці Спорядження'),
                    children: [
                      Column(
                ...
                ExpansionTile(title: Text('Таблиці Дееталей Персонажа'),
                    children: [
                      Column(
                        children: List.generate(4, (index) {
                          final key = 'table_${index + 1}';
                ...
                ExpansionTile(title: Text('Таблиці Навичок Персонажа'),
                    children: [
                      Column(
